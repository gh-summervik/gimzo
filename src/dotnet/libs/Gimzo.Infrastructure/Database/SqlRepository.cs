...
";
    ...
    public const string InsertBacktestTrades = @"
INSERT INTO public.backtest_trades (
    ...
    mfe_percent,
    mae_percent,
    entry_prev_high_price,
    entry_prev_low_price,
    entry_percent_from_prev_high,
    entry_percent_from_prev_low,
    entry_atr,
    entry_avg_volume,
    entry_relative_volume,
    entry_num_up_days,
    entry_num_down_days,
    entry_num_green_days,
    entry_num_red_days,
    entry_prior_slope,
    entry_rsi,
    entry_ma_distances,
    exit_prev_high_price,
    exit_prev_low_price,
    exit_percent_from_prev_high,
    exit_percent_from_prev_low,
    exit_atr,
    exit_avg_volume,
    exit_relative_volume,
    exit_num_up_days,
    exit_num_down_days,
    exit_num_green_days,
    exit_num_red_days,
    ...
    @EntryPrevHighPrice,
    @EntryPrevLowPrice,
    @EntryPercentFromPrevHigh,
    @EntryPercentFromPrevLow,
    @EntryAtr,
    @EntryAvgVolume,
    @EntryRelativeVolume,
    @EntryNumUpDays,
    ...
    @EntryPriorSlope,
    @EntryRsi,
    @EntryMaDistances::jsonb,
    @ExitPrevHighPrice,
    @ExitPrevLowPrice,
    @ExitPercentFromPrevHigh,
    @ExitPercentFromPrevLow,
    @ExitAtr,
    @ExitAvgVolume,
    @ExitRelativeVolume,
    @ExitNumUpDays,
    ...
    public const string SelectBacktestTrades = $@"
SELECT
    trade_id AS TradeId,
    ...
    mfe_price AS MfePrice,
    mae_price AS MaePrice,
    mfe_percent AS MfePercent,
    mae_percent AS MaePercent,
    entry_prev_high_price AS EntryPrevHighPrice,
    entry_prev_low_price AS EntryPrevLowPrice,
    entry_percent_from_prev_high AS EntryPercentFromPrevHigh,
    entry_percent_from_prev_low AS EntryPercentFromPrevLow,
    entry_atr AS EntryAtr,
    entry_avg_volume AS EntryAvgVolume,
    entry_relative_volume AS EntryRelativeVolume,
    entry_num_up_days AS EntryNumUpDays,
    entry_num_down_days AS EntryNumDownDays,
    entry_num_green_days AS EntryNumGreenDays,
    entry_num_red_days AS EntryNumRedDays,
    entry_prior_slope AS EntryPriorSlope,
    entry_rsi AS EntryRsi,
    entry_ma_distances AS EntryMaDistances,
    exit_prev_high_price AS ExitPrevHighPrice,
    exit_prev_low_price AS ExitPrevLowPrice,
    exit_percent_from_prev_high AS ExitPercentFromPrevHigh,
    exit_percent_from_prev_low AS ExitPercentFromPrevLow,
    exit_atr AS ExitAtr,
    exit_avg_volume AS ExitAvgVolume,
    exit_relative_volume AS ExitRelativeVolume,
    exit_num_up_days AS ExitNumUpDays,
    exit_num_down_days AS ExitNumDownDays,
    exit_num_green_days AS ExitNumGreenDays,
    exit_num_red_days AS ExitNumRedDays,
    exit_prior_slope AS ExitPriorSlope,
    exit_rsi AS ExitRsi,
    exit_ma_distances AS ExitMaDistances,
