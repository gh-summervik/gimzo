...
FROM public.us_companies";
    ...
    public const string InsertInternationalCompanies = @"
INSERT INTO public.international_companies (
    symbol,
    registrant,
    exchange,
    isin,
    ...
    public const string MergeInternationalCompanies = @"
INSERT INTO public.international_companies (
    symbol,
    registrant,
    exchange,
    ...
    isin = EXCLUDED.isin,
    industry = EXCLUDED.industry,
    year_founding = EXCLUDED.year_founding,
    chief_executive_officer = EXCLUDED.chief_executive_officer,
    number_employees = EXCLUDED.number_employees,
    web_site = EXCLUDED.web_site,
    description = EXCLUDED.description,
    ...
    public const string SelectInternationalCompanies = @"
SELECT
    symbol,
    registrant,
    exchange AS Exchange,
    ...
    created_at_unix_ms AS CreatedAtUnixMs,
    updated_at_unix_ms AS UpdatedAtUnixMs
FROM public.international_companies";
...
SELECT
    ...
    days_to_convert AS DaysToConvert,
