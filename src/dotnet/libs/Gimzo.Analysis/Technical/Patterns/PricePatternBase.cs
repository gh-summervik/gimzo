...
//    public abstract Func<ArraySegment<Ohlc>, bool> IsMatch { get; init; }
...
//        //TODO: fix
//        //if (IsMatch(chartSpan.Candlesticks.Select(x => x as Ohlc)))
//        //{
...
//    public virtual IEnumerable<(int Start, int Finish)> FindAll(ArraySegment<Ohlc> ohlc)
//    {
//        for (int i = 0; i < ohlc.Count - Info.NumberRequired + 1; i++)
//        {
//            if (IsMatch(ohlc[i..(i + Info.NumberRequired)]))
...
//    {
//        foreach (var (Start, Finish) in FindAll(chartSpan.PriceActions))
//        {
//            yield return new PatternMatch()
//            {
//                ChartInfo = chartSpan.ChartInfo,
//                PatternInfo = Info,
//                Date = chartSpan.PriceActions[Finish].Date,
//                Location = new ChartPositionRange(Start, Finish)
//            };
//        }
//    }
